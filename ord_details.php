...
<body>
    ...
    <!--register.html-->
    <div class="reg">
        <form name="myform" id="myform" method="post" action="order_details.php" onsubmit="reset(); return false();">
            ...
            <button type="button" data-inline="true" onclick="location.href='product.html'">Back</button>
        ...
        <div class="popup" id="popup">
            ...
            <h2>Thank You!</h2>
            <p>Your order details has been successfully submitted. Thanks!</p>
